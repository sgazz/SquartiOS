...
final class SquartSceneMaterials {
    ...
    func apply(theme: SquartVisualTheme, animated: Bool) {
        ...
        let changes = {
            ...
            Self.configure(self.horizontalPiece, color: palette.horizontalPiece, emission: palette.horizontalPieceEmission, roughness: 0.60, metalness: 0.20)
            Self.configure(self.verticalPiece, color: palette.verticalPiece, emission: palette.verticalPieceEmission, roughness: 0.62, metalness: 0.14)
            Self.configure(self.horizontalPieceAccent, color: palette.horizontalPieceAccent, emission: palette.horizontalPieceAccentEmission, roughness: 0.46, metalness: 0.28)
            Self.configure(self.verticalPieceAccent, color: palette.verticalPieceAccent, emission: palette.verticalPieceAccentEmission, roughness: 0.48, metalness: 0.18)
